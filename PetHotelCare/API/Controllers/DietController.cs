...
namespace PetHotelCare.API.Controllers
{
    ...
    public class DietController : CrudController<DietRequest, DietModel, Diet>
    {
        ...
        public DietController(ApplicationDbContext context, IMapper mapper) : base(context, mapper)
        {
            _context = context;
        }
        ...
        public async Task<PaginationModel<DietModel>> GetAsync(int page = 1, string? query = "")
        {
