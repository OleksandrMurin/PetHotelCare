...
namespace PetHotelCare.API.Controllers
{
    ...
    public class RoomTypeController : CrudController<RoomTypeRequest, RoomTypeModel, RoomType>
    {
        ...
        public RoomTypeController(ApplicationDbContext context, IMapper mapper) : base(context, mapper)
        {
            _context = context;
        }
        ...
        public async Task<PaginationModel<RoomTypeModel>> GetAsync(int page = 1, string? query = "")
        {
