...
namespace PetHotelCare.Migrations
{
    ...
    [Migration("20240518182714_AddNewEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductTag", b =>
                {
                    b.Property<int>("ProductsTagId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("TagsProductId")
                        .HasColumnType("INTEGER");

                    b.HasKey("ProductsTagId", "TagsProductId");

                    b.HasIndex("TagsProductId");
            ...
            modelBuilder.Entity("ProductTag", b =>
                {
                    b.HasOne("PetHotelCare.DataAccess.Entities.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductsTagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PetHotelCare.DataAccess.Entities.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagsProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
