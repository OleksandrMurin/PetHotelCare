    ...
    public partial class AddNewEntities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Name = table.Column<string>(type: "TEXT", nullable: false),
                    PricePer100g = table.Column<double>(type: "REAL", nullable: false),
                    CaloricValue = table.Column<int>(type: "INTEGER", nullable: false),
                    ProtsContent = table.Column<int>(type: "INTEGER", nullable: false),
                    FatsContent = table.Column<int>(type: "INTEGER", nullable: false),
                    CarbohydratesContent = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductsInRations", x => new { x.RationId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_ProductsInRations_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductsInRations_Rations_RationId",
                        column: x => x.RationId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductsTagId = table.Column<int>(type: "INTEGER", nullable: false),
                    TagsProductId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductTag", x => new { x.ProductsTagId, x.TagsProductId });
                    table.ForeignKey(
                        name: "FK_ProductTag_Products_ProductsTagId",
                        column: x => x.ProductsTagId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductTag_Tags_TagsProductId",
                        column: x => x.TagsProductId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RationsTagId = table.Column<int>(type: "INTEGER", nullable: false),
                    TagsInRationId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RationTag", x => new { x.RationsTagId, x.TagsInRationId });
                    table.ForeignKey(
                        name: "FK_RationTag_Rations_RationsTagId",
                        column: x => x.RationsTagId,
                        principalTable: "Rations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RationTag_Tags_TagsInRationId",
                        column: x => x.TagsInRationId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bookings_Rations_RationId",
                        column: x => x.RationId,
                        principalTable: "Rations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductsInRations_ProductId",
