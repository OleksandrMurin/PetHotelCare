...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.WithOrigins("http://localhost:3000") // ”кажите адрес вашего React-приложени€
              .AllowAnyHeader() 
              .AllowAnyMethod() 
              .AllowCredentials(); 
...
builder.Services.AddSwaggerGen();                       //я не понимаю как пон€ть что за сервисы у мен€ используюс€ и как их подключить
